...
button:hover {
	...
	summaryDialog() {
		document.dispatchEvent(new CustomEvent('popup', { detail: { body: '<input-selection></input-selection><div style="text-align: center; padding-top: 1.5em;"><button onclick="document.querySelector(&quot;view-statistics&quot;).summary()">KI fragen</button></div>' } }));
