...
${dialog.stylePictures}`;
		...
		buttonToggle.setAttribute('style', 'position: absolute; cursor: pointer; background: rgba(0, 0, 120, 0.4); color: white; top: 0.31em; right: 0.31em; border-radius: 0 0.3em 0.3em 0; width: 1.32em; height: 1.25em; font-size: 1.6em; text-align: center; padding: 0 0.16em;');
